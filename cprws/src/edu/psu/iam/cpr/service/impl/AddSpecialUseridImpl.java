...
import edu.psu.iam.cpr.core.api.AddSpecialUseridApi;
 ...
 */
public class AddSpecialUseridImpl extends BaseServiceImpl {
	...
	public void runService(String serviceName, Database db,
		...
		new AddSpecialUseridApi().implementApi(serviceName, db, updatedBy, serviceCoreReturn, 
