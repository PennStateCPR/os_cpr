/* SVN FILE: $Id: AddSpecialUseridImpl.java 5343 2012-09-27 14:56:40Z jvuccolo $ */
 ...
 */
public class AddSpecialUseridImpl implements ServiceInterface {
	...
	public Object implementService(String serviceName, String ipAddress,
		...
		try {
			/**
			 * Build the parameters to store in the database log.
			 * Obtain the IP address of the caller.
			 * Initialize database logging.
			 * Initialize the service.
			 * Validate the callers input parameters
			 * Determine if the caller is authorized to perform the database update.
			 * Call addSpecialUserid(special userid)
			 * Build the service return class.
			...
			parameters.append("identifierType=[PERSON_ID] ");
			...
			LOG4J_LOGGER.info(serviceName + ": adding special userid=" + userid);
