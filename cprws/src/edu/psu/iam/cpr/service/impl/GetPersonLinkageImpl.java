...
public class GetPersonLinkageImpl implements ServiceInterface {
	...
	final private static Logger log4jLogger = Logger.getLogger(GetPersonLinkageImpl.class);
	...
	public Object implementService(String serviceName, String ipAddress,
		...
		try {
			...
			log4jLogger.info(serviceName + ": get person linkage, records returned = " + queryResults.length);
			...
			return (Object) new PersonLinkageServiceReturn(ReturnType.GENERAL_DATABASE_EXCEPTION.index(), e.getMessage());
		} 
			...
			return (Object) new PersonLinkageServiceReturn(ReturnType.RECORD_NOT_FOUND_EXCEPTION.index(), e.getMessage());
		}
