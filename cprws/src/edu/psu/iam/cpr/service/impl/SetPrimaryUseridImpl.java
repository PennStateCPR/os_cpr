...
/**
 * This class provides an implementation for the set primary userid service.
 * 
...
public class SetPrimaryUseridImpl implements ServiceInterface {
	...
	private static final Logger LOG4J_LOGGER = Logger.getLogger(SetPrimaryUseridImpl.class);
	...
	public Object implementService(String serviceName, String ipAddress,
		...
		try {
			...
			// Determine if the user is authorized to set a primary userid.
