...
public class SetPrimaryPhoneByTypeImpl implements ServiceInterface {
	...
	final private static Logger log4jLogger = Logger.getLogger(SetPrimaryPhoneByTypeImpl.class);
	...
	public Object implementService(String serviceName, String ipAddress,
		...
		log4jLogger.info("SetPrimaryByType: Start of service.");
		try {
			...
			log4jLogger.info("SetPrimaryByType: Input Parameters = " + parameters.toString());			
			...
			serviceCoreReturn = serviceHelper.initializeService(serviceName, 
					...
					db, 
					parameters);
			log4jLogger.info("SetPrimaryByType: Found Person Id = " + serviceCoreReturn.getPersonId());
			...
			// Log Success
			log4jLogger.info("SetPrimaryByType: Status = SUCCESS, primary flag set");
		...
		log4jLogger.info("SetPrimaryByType: End of service.");
