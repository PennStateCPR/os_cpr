...
public class ArchiveAddressImpl implements ServiceInterface {
	...
	final private static Logger log4jLogger = Logger.getLogger(ArchiveAddressImpl.class);
	...
	public Object implementService(String serviceName, String ipAddress,
		...
		log4jLogger.info("ArchiveAddress: Start of service.");
		try {
			...
			log4jLogger.info("ArchiveAddress: Input Parameters = " + parameters.toString());
			...
			serviceCoreReturn = serviceHelper.initializeService(serviceName, 
					...
					db, 
					parameters);
			log4jLogger.info("ArchiveAddress: Found Person Id = " + serviceCoreReturn.getPersonId());
			...
			// Log a success!
			log4jLogger.info("ArchiveAddress: Status = SUCCESS, record archived");
		...
		log4jLogger.info("ArchiveAddress: End of service.");
