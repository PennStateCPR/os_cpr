/* SVN FILE: $Id: AddConfidentialityHoldImpl.java 5343 2012-09-27 14:56:40Z jvuccolo $ */
 ...
 */
public class AddConfidentialityHoldImpl implements ServiceInterface {

	final private static Logger LOG4J_LOGGER = Logger.getLogger(AddConfidentialityHoldImpl.class);
	...
	public Object implementService(String serviceName, String ipAddress,
		...
		LOG4J_LOGGER.info("AddConfidentialityHold: Start of service.");
		try {
			...
			LOG4J_LOGGER.info("AddConfidentialityHold: input parameters = " + parameters.toString());
			...
			serviceCoreReturn = serviceHelper.initializeService(serviceName, 
					...
					db, 
					parameters);
			LOG4J_LOGGER.info("AddConfidentialityHold: Person identifier = " + serviceCoreReturn.getPersonId());
			
			// Validate the input parameters.
			final ConfidentialityTable confidentialityTable = ValidateConfidentiality.validateAddConfidentialityParameters(db, 
			...
			// Establish the hold.
			LOG4J_LOGGER.info("AddConfidentialityHold: Add confidentiality hold.");
			confidentialityTable.addConfidentiality(db);
			...
			LOG4J_LOGGER.info("AddConfidentialityHold: JSON Message = " + jsonMessage.toString());
		...
		LOG4J_LOGGER.info("AddConfidentialityHold: End of service.");
