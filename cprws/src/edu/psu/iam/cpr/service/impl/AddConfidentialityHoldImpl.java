...
public class AddConfidentialityHoldImpl implements ServiceInterface {
	...
	final private static Logger log4jLogger = Logger.getLogger(AddConfidentialityHoldImpl.class);
	...
	public Object implementService(String serviceName, String ipAddress,
		...
		log4jLogger.info("AddConfidentialityHold: Start of service.");
		try {
			...
			log4jLogger.info("AddConfidentialityHold: input parameters = " + parameters.toString());
			...
			serviceCoreReturn = serviceHelper.initializeService(serviceName, 
					...
					db, 
					parameters);
			log4jLogger.info("AddConfidentialityHold: Person identifier = " + serviceCoreReturn.getPersonId());
			...
			// Establish the hold.
			log4jLogger.info("AddConfidentialityHold: Add confidentiality hold.");
			...
			log4jLogger.info("AddConfidentialityHold: JSON Message = " + jsonMessage.toString());
		...
		log4jLogger.info("AddConfidentialityHold: End of service.");
