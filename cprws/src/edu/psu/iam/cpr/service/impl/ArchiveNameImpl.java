...
import edu.psu.iam.cpr.core.api.ArchiveNameApi;
 ...
 */
public class ArchiveNameImpl extends BaseServiceImpl {
	...
	public void runService(String serviceName, Database db,
		...
		new ArchiveNameApi().implementApi(serviceName, db, updatedBy, serviceCoreReturn, 
