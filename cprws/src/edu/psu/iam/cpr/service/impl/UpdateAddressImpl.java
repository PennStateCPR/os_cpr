 ...
 */
public class UpdateAddressImpl extends GenericServiceImpl {
	...
	/** Contains the index for address1 parameter */
	private static final int ADDRESS1 = 3;
	
	/** Contains the index for the address2 parameter */
	private static final int ADDRESS2 = 4;
	
	/** Contains the index for the address3 parameter */
	private static final int ADDRESS3 = 5;
	...
	/** Contains the index for the postal code parameter */
