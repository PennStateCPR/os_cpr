/* SVN FILE: $Id: AddPersonIdentifierImpl.java 5343 2012-09-27 14:56:40Z jvuccolo $ */
...
/**
 * This class provides the implementation for the Add Person Identifier service.
 * 
 ...
 */
public class AddPersonIdentifierImpl implements ServiceInterface {

	final private static Logger LOG4J_LOGGER = Logger.getLogger(AddPersonIdentifierImpl.class);
	...
	public Object implementService(String serviceName, String ipAddress,
		...
		try {
			...
			final String registryIdentifierValue = (String) otherParameters[1];
			...
			parameters.append("registryIdentifierValue=[").append(registryIdentifierValue).append("] ");
			...
			LOG4J_LOGGER.info(serviceName + ": added person identifier");
