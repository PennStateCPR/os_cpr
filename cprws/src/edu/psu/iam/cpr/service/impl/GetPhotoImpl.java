...
public class GetPhotoImpl implements ServiceInterface {
	...
	final private static Logger log4jLogger = Logger.getLogger(GetPhotoImpl.class);
	...
	public Object implementService(String serviceName, String ipAddress,
		...
		try {
			...
			return (Object) new PhotoServiceReturn(ReturnType.GENERAL_DATABASE_EXCEPTION.index(), e.getMessage());
		} 
		catch (Exception e) {
