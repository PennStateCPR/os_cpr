...
import edu.psu.iam.cpr.core.api.UnarchiveUseridApi;
 ...
 */
public class UnarchiveUseridImpl extends BaseServiceImpl {
	...
	public void runService(String serviceName, Database db,
		...
		new UnarchiveUseridApi().implementApi(serviceName, db, updatedBy, serviceCoreReturn, 
