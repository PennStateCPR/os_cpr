/* SVN FILE: $Id: UpdateAffiliationImpl.java 5343 2012-09-27 14:56:40Z jvuccolo $ */
...
/**
 * This class provides an implementation for the update affiliation service.
 * 
...
public class UpdateAffiliationImpl implements ServiceInterface {
	...
	final private static Logger log4jLogger = Logger.getLogger(UpdateAffiliationImpl.class);
	...
	public Object implementService(String serviceName, String ipAddress,
		...
		log4jLogger.info("UpdateAffiliation: Start of service.");
		try {
			...
			log4jLogger.info("UpdateAffiliation: Input Parameters = " + parameters.toString());
			...
			serviceCoreReturn = serviceHelper.initializeService(serviceName, 
					...
					db, 
					parameters);
			log4jLogger.info("UpdateAffiliation: Found Person Id = " + serviceCoreReturn.getPersonId());
			...
			aTableRecord.updateAffiliation(db);
			...
			// Log success
			log4jLogger.info("UpdateAffiliation: Status = SUCCESS, affiliation updated");
		...
		log4jLogger.info("UpdateAffiliation: End of service.");
