...
/**
 * This class provides an implementation for the get id card number service
 *
...
public class GetIdCardNumberImpl implements ServiceInterface {
	...
	public Object implementService(String serviceName, String ipAddress,
		...
		PersonIdCardNumberServiceReturn serviceReturn = null;
		...
		try {
			...
			serviceReturn = new PersonIdCardNumberServiceReturn();
