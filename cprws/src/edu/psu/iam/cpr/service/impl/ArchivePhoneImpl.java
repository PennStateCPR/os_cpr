/* SVN FILE: $Id: ArchivePhoneImpl.java 5343 2012-09-27 14:56:40Z jvuccolo $ */
 ...
 */
public class ArchivePhoneImpl implements ServiceInterface {

	private static final Logger LOG4J_LOGGER = Logger.getLogger(ArchivePhoneImpl.class);
	...
	public Object implementService(String serviceName, String ipAddress,
		...
		LOG4J_LOGGER.info("ArchivePhone: Start of service.");
		try {
			...
			LOG4J_LOGGER.info("ArchivePhone: Input Parameters = " + parameters.toString());
			...
			serviceCoreReturn = serviceHelper.initializeService(serviceName, 
					...
					db, 
					parameters);
			LOG4J_LOGGER.info("ArchivePhone: Found Person Id = " + serviceCoreReturn.getPersonId());

			// Validate the data passed to the service		
			final PhonesTable phonesTableRecord = ValidatePhone.validateArchiveAndSetPrimaryPhonesParameters(db, serviceCoreReturn.getPersonId(), 
			...
			phonesTableRecord.archivePhone(db);
			...
			// Log Success
			LOG4J_LOGGER.info("ArchivePhone: Status = SUCCESS, Phone archived");
		...
		LOG4J_LOGGER.info("ArchivePhone: End of service.");
