...
public class ArchivePhoneImpl implements ServiceInterface {
	...
	final private static Logger log4jLogger = Logger.getLogger(ArchivePhoneImpl.class);
	...
	public Object implementService(String serviceName, String ipAddress,
		...
		log4jLogger.info("ArchivePhone: Start of service.");
		try {
			...
			log4jLogger.info("ArchivePhone: Input Parameters = " + parameters.toString());
			...
			serviceCoreReturn = serviceHelper.initializeService(serviceName, 
					...
					db, 
					parameters);
			log4jLogger.info("ArchivePhone: Found Person Id = " + serviceCoreReturn.getPersonId());
			...
			// Log Success
			log4jLogger.info("ArchivePhone: Status = SUCCESS, Phone archived");
		...
		log4jLogger.info("ArchivePhone: End of service.");
