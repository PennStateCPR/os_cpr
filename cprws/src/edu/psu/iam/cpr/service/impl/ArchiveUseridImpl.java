...
public class ArchiveUseridImpl implements ServiceInterface {
	...
	final private static Logger log4jLogger = Logger.getLogger(ArchiveUseridImpl.class);
	...
	public Object implementService(String serviceName, String ipAddress,
		...
		try {
			...
			log4jLogger.info(serviceName + ": archiving the userid.");
			...
			log4jLogger.info(serviceName + ": the archive was successful.");
