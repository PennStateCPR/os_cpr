/* SVN FILE: $Id: ArchiveUseridImpl.java 5343 2012-09-27 14:56:40Z jvuccolo $ */
...
import edu.psu.iam.cpr.core.api.ArchiveUseridApi;
 ...
 */
public class ArchiveUseridImpl extends BaseServiceImpl {
     ...
     * @throws JMSException will  be thrown if there are any issues related to messaging.
     */	
	@Override
	public void runService(String serviceName, Database db,
		...
		new ArchiveUseridApi().implementApi(serviceName, db, updatedBy, serviceCoreReturn, 
