 ...
 */
public class ArchiveUseridImpl implements ServiceInterface {

	private static final Logger LOG4J_LOGGER = Logger.getLogger(ArchiveUseridImpl.class);
	...
	public Object implementService(String serviceName, String ipAddress,
		...
		try {
			...
			LOG4J_LOGGER.info(serviceName + ": archiving the userid.");
			...
			LOG4J_LOGGER.info(serviceName + ": the archive was successful.");
