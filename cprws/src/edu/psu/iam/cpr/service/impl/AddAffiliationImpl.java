...
public class AddAffiliationImpl implements ServiceInterface {
	...
	final private static Logger log4jLogger = Logger.getLogger(AddAffiliationImpl.class);
	...
	public Object implementService(String serviceName, String ipAddress,
		...
		log4jLogger.info("AddAffiliation: Start of service.");
		try {
			...
			log4jLogger.info("AddAffiliation: Input Parameters = " + parameters.toString());
			...
			serviceCoreReturn = serviceHelper.initializeService(serviceName, 
					...
					db, 
					parameters);
			log4jLogger.info("AddAffiliation: Found Person Id = " + serviceCoreReturn.getPersonId());
			...
			// log success
			log4jLogger.info("AddAffiliation: Status = SUCCESS, affiliation added");
		...
		log4jLogger.info("AddAffiliation: End of service.");
