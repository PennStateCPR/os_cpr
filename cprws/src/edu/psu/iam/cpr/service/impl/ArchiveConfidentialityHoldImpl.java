...
import edu.psu.iam.cpr.core.api.ArchiveConfidentialityHoldApi;
...
public class ArchiveConfidentialityHoldImpl extends BaseServiceImpl {
	...
	public void runService(String serviceName, Database db,
		...
		new ArchiveConfidentialityHoldApi().implementApi(serviceName, db, updatedBy, serviceCoreReturn, 
