...
public class AddPhoneImpl implements ServiceInterface {
	...
	public Object implementService(String serviceName, String ipAddress,
		...
		log4jLogger.info("AddPhone: Start of service.");
		...
		try {
			...
			log4jLogger.info("AddPhone: Input Parameters = " + parameters.toString());
			...
			log4jLogger.info("AddPhone: Found Person Id = " + serviceCoreReturn.getPersonId());
			...
			// Log Success
			log4jLogger.info("AddPhone: Status = SUCCESS, Phone added");
		...
		log4jLogger.info("AddPhone: End of service.");
