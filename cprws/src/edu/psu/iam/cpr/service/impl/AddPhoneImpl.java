...
public class AddPhoneImpl implements ServiceInterface {
	...
	public Object implementService(String serviceName, String ipAddress,
		...
		LOG4J_LOGGER.info("AddPhone: Start of service.");
		...
		try {
			...
			LOG4J_LOGGER.info("AddPhone: Input Parameters = " + parameters.toString());
			...
			LOG4J_LOGGER.info("AddPhone: Found Person Id = " + serviceCoreReturn.getPersonId());
