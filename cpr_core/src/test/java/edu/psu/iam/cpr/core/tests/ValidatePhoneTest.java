...
public class ValidatePhoneTest {
 ...
 @Test(expectedExceptions=Exception.class)
	...
	public final void testValidateArchivePhonesGroupId() throws Exception {
		openDbConnection();
		ValidatePhone.validateArchiveAndSetPrimaryPhonesParameters(db, 100000, null, null,"system", null);
		db.closeSession();
	}
	/**
	 * Test method for {@link edu.psu.iam.cpr.core.database.tables.validate.ValidatePhone#validateArchivePhonesParameters(int, java.lang.String, java.lang.String)}.
	...
	public final void testValidateArchivePhonesNullRequestedBy() throws Exception {
		openDbConnection();
		ValidatePhone.validateArchiveAndSetPrimaryPhonesParameters(db, 0, "permanent_phone", 1L, null, null);
		db.closeSession();
	...
	public final void testValidateArchivePhonesTooLongRequestedBy() throws Exception {
		openDbConnection();
		ValidatePhone.validateArchiveAndSetPrimaryPhonesParameters(db, 0, "permanent_phone", 1L, "asdfghjklzxcvbnmqwertyuiopasdfgh", null);
		db.closeSession();
	}
	...
	public final void testValidateGetPhonesParametersRequestedByNull() throws Exception {
		openDbConnection();
		ValidatePhone.validateGetPhonesParameters(db, 0, null,null,"Y", null);
		db.closeSession();
	}
	...
	public final void testValidateGetPhonesRequestedTooLong() throws Exception {
		openDbConnection();
		ValidatePhone.validateGetPhonesParameters(db, 0,  "asdfghjklqwertyuiopzxcvbnmasdfg",null,"Y", null);
		db.closeSession();
	}
	...
	public final void testValidateGetPhonesParametersAll() throws Exception {
		openDbConnection();
		PhonesTable phonesTable = ValidatePhone.validateGetPhonesParameters(db, 100000, "cpruser","work_phone","n", null);
