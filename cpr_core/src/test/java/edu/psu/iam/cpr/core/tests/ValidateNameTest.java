...
public class ValidateNameTest {
	...
	public final void _01testValidateGetNameParameters1() throws Exception {
		openDbConnection();
		ValidateName.validateGetNameParameters(db, 1000000, null,null,null, null);
		db.closeSession();
	}
	@Test
	public final void _02testValidateGetNameParameters2() throws Exception {
		openDbConnection();
		ValidateName.validateGetNameParameters(db, 100000, "jimmy",null,"Y", null);
		db.closeSession();
	}
	@Test(expectedExceptions=Exception.class)
	public final void _03testValidateGetNameParameters3() throws Exception {
		openDbConnection();
		ValidateName.validateGetNameParameters(db, 100000, "1234567890123456789012345678901",null,"Y", null);
		db.closeSession();
	}
	@Test(expectedExceptions=Exception.class)
	public final void _04testValidateGetNameParameters4() throws Exception {
		openDbConnection();
		ValidateName.validateGetNameParameters(db, 100000, "                                       ",null,"Y", null);
		db.closeSession();
	}
	@Test(expectedExceptions=Exception.class)
	public final void _05testValidateGetNameParameters5() throws Exception {
		openDbConnection();
		ValidateName.validateGetNameParameters(db, 100000, "jimmy","legal","Y", null);
		db.closeSession();
	}
	@Test(expectedExceptions=Exception.class)
	public final void _06testValidateGetNameParameters6() throws Exception {
		openDbConnection();
		ValidateName.validateGetNameParameters(db, 100000, "jimmy",null,"dabc", null);
		db.closeSession();
	}
	@Test
	public final void _07testValidateGetNameParameters7() throws Exception {
		openDbConnection();
		NamesTable namesTable = ValidateName.validateGetNameParameters(db, 100000, "jimmy","legal_name","y", null);
	...
	public final void _08testValidateGetNameParameters8() throws Exception {
		openDbConnection();
		NamesTable namesTable = ValidateName.validateGetNameParameters(db, 100000, "jimmy",null,"y", null);
	...
	public final void _09testValidateDeleteNameParameters1() throws Exception {
		openDbConnection();
		ValidateName.validateArchiveNameParameters(db, 100000, null, null, null, null);
		db.closeSession();
	}
	@Test(expectedExceptions=Exception.class)
	public final void _10testValidateDeleteNameParameters2() throws Exception {
		openDbConnection();
		ValidateName.validateArchiveNameParameters(db, 100000, "home", null, null, null);
		db.closeSession();
	...
	public final void _11testValidateDeleteNameParameters3() throws Exception {
		openDbConnection();
		ValidateName.validateArchiveNameParameters(db, 100000, "home", "", "cpruser", null);
		db.closeSession();
	...
	public final void _12testValidateDeleteNameParameters4() throws Exception {
		openDbConnection();
		ValidateName.validateArchiveNameParameters(db, 100000, "legal_name", "", "cpruser", null);
		db.closeSession();
	}
	...
	public final void _13testValidateDeleteNameParameters5() throws Exception {
		openDbConnection();
		ValidateName.validateArchiveNameParameters(db, 100000, "common_name", "", "1234567890123456789012345678902121", null);
		db.closeSession();
	}
	...
	public final void _14testValidateDeleteNameParameters6() throws Exception {
		openDbConnection();
		ValidateName.validateArchiveNameParameters(db, 100000, "common_name", "", "                                           ", null);
		db.closeSession();
	}
