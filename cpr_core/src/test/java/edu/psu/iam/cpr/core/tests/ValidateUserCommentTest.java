...
public class ValidateUserCommentTest {
	...
	public final void testValidateUserCommentParameters1() throws Exception {
		ValidateUserComment.validateGetUserCommentsParameters(db, 100000, null,null,"N", null);
	}
	...
	public final void testValidateUserCommentParameters2() throws Exception {
		ValidateUserComment.validateGetUserCommentsParameters(db, 100000, "",null,"N", null);
	}
	...
	public final void testValidateUserCommentParameters3() throws Exception {
		openDbConnection();
		ValidateUserComment.validateGetUserCommentsParameters(db, 100000, "1234567890123456789012345678901",null,"N", null);
		db.closeSession();
	}
	...
	public final void testValidateUserCommentParameters4() throws Exception {
		openDbConnection();
		ValidateUserComment.validateGetUserCommentsParameters(db, 100000, "cpruser",null,"Y", null);
		db.closeSession();
	}
	...
	public final void testValidateUserCommentParameters37() throws Exception {
		openDbConnection();
		UserCommentTable userCommentTable  = ValidateUserComment.validateGetUserCommentsParameters(db, 100000, "cpruser","USER_COMMENT_MISUSE","Y", null);
	...
	/**
	 * Test method for {@link edu.psu.iam.cpr.core.database.tables.validate.ValidateUserComment#validateArchiveUserCommentParameters(Database, long, java.lang.String, java.lang.String, java.lang.String, String)}.
	 * @throws Exception 
	 * @throws Exception 
	 */
	@Test(expectedExceptions=Exception.class)
	public final void testValidateUserCommentParameters18() throws Exception {
		ValidateUserComment.validateArchiveUserCommentParameters( db, 100000, null, null, null, null ); 
	}
	...
	public final void testValidateUserCommentParameters20() throws Exception {
		ValidateUserComment.validateArchiveUserCommentParameters( db, 100000, "tzj115", null, null, null ); 
	}
	...
	public final void testValidateUserCommentParameters22() throws Exception {
		ValidateUserComment.validateArchiveUserCommentParameters( db, 100000, "tzj115", "USER_COMMENT_MISUSE", null, null ); 
	}
	...
	public final void testValidateUserCommentParameters24() throws Exception {
		openDbConnection();
		ValidateUserComment.validateArchiveUserCommentParameters( db, 100000, "1234567890123456789012345678901", "USER_COMMENT_MISUSE", "cpruser", null ); 
		db.closeSession();
	}
	...
	public final void testValidateUserCommentParameters25() throws Exception {
		openDbConnection();
		ValidateUserComment.validateArchiveUserCommentParameters( db, 100000, "tzj115", "USER_COMMENT_MISUSE", "1234567890123456789012345678901", null ); 
		db.closeSession();
	}
	...
	public final void testValidateUserCommentParameters26() throws Exception {
		openDbConnection();
		ValidateUserComment.validateArchiveUserCommentParameters( db, 100000, "tzj115", "USER_COMMENT_MISUSE!", "cpruser", null ); 
		db.closeSession();
	}
