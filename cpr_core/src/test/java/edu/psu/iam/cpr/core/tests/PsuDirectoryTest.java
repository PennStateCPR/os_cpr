...
public class PsuDirectoryTest {

	PsuDirectory p = new PsuDirectory();
	Date d = new Date();
	
	@Test
	public final void testPsuDirectory() {
	...
	@Test
	public final void testGetPsuDirectoryKey() {
		p.setPsuDirectoryKey(1L);
		AssertJUnit.assertEquals(p.getPsuDirectoryKey(),new Long(1));
	}
	...
	public final void testGetUserid() {
		p.setUserid("abcd");
		AssertJUnit.assertEquals(p.getUserid(),"abcd");
	}
