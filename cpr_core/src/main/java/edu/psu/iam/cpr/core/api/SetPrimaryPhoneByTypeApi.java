...
/**
 * This class provides the implementation for the Set Primary Phone By Type API.
 * 
 ...
 * @lastrevision $Date$
 */
public class SetPrimaryPhoneByTypeApi extends BaseApi {
	...
	public JsonMessage runApi(final String apiName, final Database db, final ServiceCoreReturn serviceCoreReturn,
		...
		final PhonesTable phonesTableRecord = ValidatePhone.validateArchiveAndSetPrimaryPhonesParameters(db, 
				personId, phoneType,  groupId, updatedBy, null);
