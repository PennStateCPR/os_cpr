...
public final class ValidateIdCardPrintLog {
	 ...
	 * @throws CprException
	 */
	public static IdCardPrintLogTable validateAddIdCardPrintLogParameters (final Database db,final String idType, final String identifier,  
			final String eventUserId, final String eventIpAddress, final String eventWorkstation) throws CprException {
	 ...
	 * @throws CprException
	 */
	public static IdCardPrintLogTable validateGetIdCardPrintLogParameters (final Database db, final String idType, final String identifier) 
		throws CprException {
		String eventIdCard = null;
