...
import edu.psu.iam.cpr.core.api.AddUserCommentApi;
 ...
 */
public class AddUserCommentImpl extends BaseServiceImpl {
	...
	public void runService(String serviceName, Database db,
		...
		AddUserCommentApi addUserCommentApi = new AddUserCommentApi();
		addUserCommentApi.implementApi(serviceName, db, updatedBy, serviceCoreReturn, 
				otherParameters, ApiHelper.DO_AUTHZ_CHECK);
		setRecordKey(addUserCommentApi.getRecordKey());
	}
}
