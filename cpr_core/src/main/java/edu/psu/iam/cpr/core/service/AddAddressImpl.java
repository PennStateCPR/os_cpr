...
public class AddAddressImpl extends BaseServiceImpl {
   ...
   /**
	...
	public void runService(String serviceName, Database db,
		...
		AddAddressApi addAddressApi = new AddAddressApi();
		addAddressApi.implementApi(serviceName, db, updatedBy, serviceCoreReturn, otherParameters, ApiHelper.DO_AUTHZ_CHECK);
		setRecordKey(addAddressApi.getRecordKey());
	}
}
