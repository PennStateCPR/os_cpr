...
public final class ValidateUserid {
	 ...
	 * @throws CprException
	 */
	public static UseridTable validateUseridParameters(final Database db, final long personId, final String updatedBy) throws CprException {
	 ...
	 * @param userid contains the userid, which is used for RESTful services.
	 ...
	 */
	public static UseridTable validateGetUseridParameters(final Database db, final long personId, final String requestedBy, 
			final String returnHistory, final String userid) throws CprException {
	 ...
	 */
	public static UseridTable validateUseridParameters(final Database db, final long personId, final String userid, final String updatedBy) 
		throws CprException {
