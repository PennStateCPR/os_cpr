...
public class PhonesTable {
	...
	public PhonesTable(final long personId, final String phoneType, final Long groupId, final String lastUpdateBy) throws CprException
	{
	 ...
	 */
	public PhonesTable(final long personId, final String phoneType,  
			final String phoneNumber, final String extension, final String internationalNumber,
			final String lastUpdateBy) throws CprException {
	 ...
	 *
	 */
	public PhonesTable(final long personId, final String phoneType, final Long groupId,  
			final String phoneNumber, final String extension, final String internationalNumber,
			final String lastUpdateBy) throws CprException {
	...
	public PhoneReturn[] getPhones (final Database db, final long personId) {
		...
		sb.append("SELECT phone_key, data_type_key, group_id, primary_flag, phone_number, extension, international_number_flag,  ");
