...
public final class ValidatePersonAffiliation {
	 ...
	 * 
	 */
	public static PersonAffiliationTable validateAddAffiliationParameters(final Database db, final long personId, 
			final String affiliation,  final String updatedBy) 
		throws CprException {
	 ...
	 * 
	 */
	public static PersonAffiliationTable validateArchiveAffiliationParameters(final Database db, final long personId, final String affiliation,  
	 ...
	 * 
	 */
	public static PersonAffiliationTable validateGetAffiliationsForPersonIdParameters(final Database db, final long personId,  final String requestedBy, 
