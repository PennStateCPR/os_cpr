/* SVN FILE: $Id: StudentHist.java 7368 2013-05-23 20:11:49Z llg5 $ */
...
public class StudentHist implements Serializable {
        ...
        /** Student's academic leave of absence start semester.  This is the semester code for the start of the students leave of absence. */
        @Column(name="sem_loa_start", nullable=true, length=8)
        private String semLoaStart;

        /** Student's academic leave of absence end semester. This is the semester code for the end of the students leave of absence. */
        ...
        /** Student's associated person ID from the person table.  PERSON_ID and SEMESTER_CODE uniquely identify the student record in this table. */
