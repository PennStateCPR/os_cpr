/* SVN FILE: $Id: JavaExceptions.java 5340 2012-09-27 14:48:52Z jvuccolo $ */
...
public class JavaExceptions implements Serializable {
        ...
        @GeneratedValue(strategy=GenerationType.AUTO, generator="seq_java_exceptions")
        @SequenceGenerator(name="seq_java_exceptions", sequenceName="seq_java_exceptions", allocationSize = 1, initialValue= 1)
