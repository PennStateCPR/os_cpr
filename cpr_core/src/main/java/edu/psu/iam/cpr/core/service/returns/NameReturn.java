...
public class NameReturn {
	...
	/** Contains the value for the record's name key */
	...
	/** Contains the URI to the resource, RESTful services only */
	private String uri;
	...
	/**
	 * Constructor.
	 * @param nameKey contains the name key.
	 ...
	 */
	public NameReturn(String nameKey, String nameType, String documentType, String firstName,
			String middleNames, String lastName, String suffix, String nickname, String startDate,
			String endDate, String lastUpdateBy, String lastUpdateOn, String createdBy, String createdOn) {
		super();
