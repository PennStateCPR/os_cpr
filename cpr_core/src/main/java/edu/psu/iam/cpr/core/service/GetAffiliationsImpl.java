...
import edu.psu.iam.cpr.core.api.GetAffiliationApi;
 ...
 */
public class GetAffiliationsImpl extends ExtendedBaseServiceImpl {
	...
	public Object runService(Database db, String serviceName,
		...
		return (Object) new GetAffiliationApi().implementApi(serviceName, db, updatedBy, 
				serviceCoreReturn, 
