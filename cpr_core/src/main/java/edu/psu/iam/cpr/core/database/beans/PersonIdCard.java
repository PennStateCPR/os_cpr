/* SVN FILE: $Id: PersonIdCard.java 5340 2012-09-27 14:48:52Z jvuccolo $ */
...
public class PersonIdCard implements Serializable {
        ...
        @GeneratedValue(strategy=GenerationType.AUTO, generator="seq_person_id_card")
        @SequenceGenerator(name="seq_person_id_card", sequenceName="seq_person_id_card", allocationSize = 1, initialValue= 1)
        ...
        /** Contains the idSerialNumber. */
        @Column(name="id_serial_number", nullable=true, length=30)
