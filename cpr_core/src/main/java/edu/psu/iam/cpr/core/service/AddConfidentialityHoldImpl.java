...
import edu.psu.iam.cpr.core.api.AddConfidentialityHoldApi;
 ...
 */
public class AddConfidentialityHoldImpl extends BaseServiceImpl {
	...
	public void runService(String serviceName, Database db,
		...
		new AddConfidentialityHoldApi().implementApi(serviceName, db, updatedBy, serviceCoreReturn, otherParameters, 
