...
public class PersonTable {
	 ...
	 */
	public PersonTable(final long personId, final String updatedBy) {
		super();
	 ...
	 */
	public PersonTable(final String updatedBy) {
		this(-1L, updatedBy);
	}
	 ...
	 */
	public final void setPersonBean(final Person personBean) {
	 ...
	 * @throws CprException 
	 */
	public void archivePerson(final Database db) throws CprException {
	 ...
	 * @throws CprException 
	 */
	public void unarchivePerson(final Database db) throws CprException {
		boolean recordNotFound = false;
