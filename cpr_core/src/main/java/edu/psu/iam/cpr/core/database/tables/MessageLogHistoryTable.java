...
public class MessageLogHistoryTable {
	 ...
	 */
	public MessageLogHistoryTable(final MessageLog messageLogBean)  {
	 ...
	 */
	public void addMessageLogHistory(final Database db) {
	 ...
	 */
	public void updateMessageLogHistory(final Database db, final String messageId) {
