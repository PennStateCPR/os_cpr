...
/**
 * This class provides the implementation for the Get Userid API.
 * 
 ...
 * @lastrevision $Date$
 */
public class GetUseridApi extends ExtendedBaseApi {
	...
	public Object runApi(final String apiName, final Database db, final ServiceCoreReturn serviceCoreReturn,
		...
		final UseridTable useridTable = ValidateUserid.validateGetUseridParameters(db, personId, updatedBy, returnHistory, userid);
		final UseridReturn[] queryResults = useridTable.getUseridsForPersonId(db, personId);
		
		// Build the return value class.
		return (Object) new UseridServiceReturn(ReturnType.SUCCESS.index(), ApiHelper.SUCCESS_MESSAGE, 
