...
import edu.psu.iam.cpr.core.api.SetPrimaryAffiliationApi;
 ...
 */
public class SetPrimaryAffiliationImpl extends BaseServiceImpl {
	...
	public void runService(String serviceName, Database db,
		...
		new SetPrimaryAffiliationApi().implementApi(serviceName, db, updatedBy, serviceCoreReturn, 
