...
public class Database {
	 ...
	 */
	public void openSession(final SessionFactory sessionFactory) {
	 ...
	 */
	private List<Long> findRegistrationAuthority(final String principalId, final String serviceName) throws CprException {
	 ...
	 * @throws CprException will be thrown if the access is denied.
	 */
	public boolean isDataActionAuthorizedOldCode(final long iamGroupKey, final long dataTypeKey, final long accessOperationKey, final String requestedBy) 
		throws CprException {
	 ...
	 */
	public long getPersonIdUsingPersonIdentifier(final IdentifierType identifierType, final String identifier) throws CprException {
	 ...
	 * @throws CprException exception indicates a cpr specific java exception.
	 */
	public long getPersonIdUsingIdentifier(final IdentifierType identifierType, final String identifier) throws CprException {
	 ...
	 * @throws CprException 
	 */
	public long getPersonId(final String idType, final String identifier) throws CprException {
	 ...
	 */
	public void setCprAccessGroupsKey(final long cprAccessGroupsKey) {
	 ...
	 */
	public void setRegistrationAuthorityKey(final long registrationAuthorityKey) {
     ...
     */
    public IdentifierType isValidIdentifierType(final String identifierType) {
     ...
     */
    public boolean isIdentifierLengthValid(final String typeName, final String identifier) 
    throws CprException {
