...
public class AddEmailAddressImpl extends BaseServiceImpl {
	...
	public void runService(String serviceName, Database db,
		...
		AddEmailAddressApi addEmailAddressApi = new AddEmailAddressApi();
		addEmailAddressApi.implementApi(serviceName, db, updatedBy, serviceCoreReturn, otherParameters, 
				ApiHelper.DO_AUTHZ_CHECK);
		setRecordKey(addEmailAddressApi.getRecordKey());
	}
}
