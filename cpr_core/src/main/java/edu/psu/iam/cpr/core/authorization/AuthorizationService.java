...
public class AuthorizationService {
	 ...
	 */
	public boolean dataActionAuthorized(final Database db, final String dataResource, final String action, final String requestor) throws CprException {
	 ...
	 */
	public void serviceAuthorized(final Database db, final String principalId, final String requestor, final String serviceName, 
	 ...
	 */
	public void setGrouperPerm(final GrouperPermissions grouperPerm) {
