...
import edu.psu.iam.cpr.core.api.UpdateEmailAddressApi;
 ...
 */
public class UpdateEmailAddressImpl extends BaseServiceImpl {
    /**
	...
	public void runService(String serviceName, Database db,
		...
		UpdateEmailAddressApi updateEmailAddressApi = new UpdateEmailAddressApi();
		updateEmailAddressApi.implementApi(serviceName, db, updatedBy, serviceCoreReturn, 
				otherParameters, ApiHelper.DO_AUTHZ_CHECK);
		setRecordKey(updateEmailAddressApi.getRecordKey());
	}
}
