/* SVN FILE: $Id: ExtAffiliationMapping.java 5340 2012-09-27 14:48:52Z jvuccolo $ */
...
public class ExtAffiliationMapping implements Serializable {
        ...
        @GeneratedValue(strategy=GenerationType.AUTO, generator="seq_ext_affiliation_mapping")
        @SequenceGenerator(name="seq_ext_affiliation_mapping", sequenceName="seq_ext_affiliation_mapping", allocationSize = 1, initialValue= 1)
