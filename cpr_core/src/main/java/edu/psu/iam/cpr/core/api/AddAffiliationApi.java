...
/**
 * This class provides the implementation for the Add Affiliation API.
 * 
 ...
 * @lastrevision $Date$
 */
public class AddAffiliationApi extends BaseApi {
	...
	public JsonMessage runApi(final String apiName, final Database db, final ServiceCoreReturn serviceCoreReturn,
		...
		final PersonAffiliationTable aTableRecord = ValidatePersonAffiliation
				.validateAddAffiliationParameters(db, personId,
