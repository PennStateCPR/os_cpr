...
public final class ValidateAddress {
	 ...
	 * @throws CprException 
	 */
	public static boolean isAddressValid(final Database db, final String localAddress1, final String localAddress2,
			final String localAddress3, final String localCity,  final String stateName, final String localPostalCode, 
			final boolean usaAddress ) throws CprException {
	...
	public static AddressesTable validateAddAddressParameters(final Database db,
			final long personId, final String addressTypeString, final String documentType,  final String updatedBy,
			final String address1, final String address2, final String address3, final String city,
			final String stateOrProvince, final String postalCode,  final String countryCode,
	 ...
	 * @param addressKey contains the address key only used for RESTful services.
	 * @return AddressTable
	 * @throws CprException 
	 */
	public static AddressesTable validateArchiveAndSetPrimaryAddressParameters(final Database db,
			final long personId, final String addressTypeString, final String documentType, final Long groupId, 
			final String updatedBy, final String addressKey)
			throws CprException {
				
		db.getAllTableColumns(DATABASE_TABLE_NAME);
		final String localUpdatedBy = ValidateHelper.checkField(db, updatedBy, LAST_UPDATE_BY, "Updated by", true);
		
		long addressKeyValue = -1L;
		String localAddressTypeString = null;
		String localDocumentType = null;
		...
		if (addressKey == null) {
			...
			addressKeyValue = Long.valueOf(addressKey);
		}
		...
		AddressesTable addressesTable = new AddressesTable(personId, localAddressTypeString, localDocumentType, groupId, localUpdatedBy);
		addressesTable.setAddressKey(addressKeyValue);
	 ...
	 * @param addressKey TODO
	 * @return AddressesTable
	 * @throws CprException 
	 * 
	 */
	public static AddressesTable validateGetAddressParameters(final Database db, final long personId,
			final String updatedBy, final String addressType, final String returnHistory, final String addressKey) throws CprException {
	...
	public static AddressesTable validateUpdateAddressParameters(final Database db,
			final long personId, final String addressTypeString, final String documentType, final Long groupId, 
			final String updatedBy,final String address1, final String address2, final String address3, final String city,
			final String stateOrProvince, final String postalCode, final String countryCode,
			final String campusCode) throws 
			CprException {
	 ...
	 */
	public static boolean isValidCombination(final String addressType, final String documentType) {
