...
public class CredentialTable {
	 ...
	 */
	public CredentialTable(final long personId, final String credentialTypeString, final String requestedBy) throws CprException {
	 ...
	 * @throws CprException will be thrown if there is a problem determining the credential enum.
	 */
	public CredentialTable(final long personId, final String credentialTypeString, final String credentialData, final String requestedBy) throws CprException {
		super();
	 ...
	 */
	public final CredentialType findCredentialEnum(final String credentialTypeString) throws CprException{
