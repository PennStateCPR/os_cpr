...
public class GetPhoneApi extends ExtendedBaseApi {
	...
	public Object runApi(final String apiName, final Database db, final ServiceCoreReturn serviceCoreReturn,
		...
		final PhonesTable phonesTable = ValidatePhone.validateGetPhonesParameters(db, personId, 
												updatedBy, phoneType, returnHistory, phoneKey);
		
	    final PhoneReturn [] queryResults =  phonesTable.getPhones(db, personId);
		
		// Build the return value class.
		return new PhoneServiceReturn(ReturnType.SUCCESS.index(), ApiHelper.SUCCESS_MESSAGE, 
