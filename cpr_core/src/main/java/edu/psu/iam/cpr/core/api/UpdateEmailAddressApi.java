...
/**
 * This class provides the implementation for the Update Email Address API.
 * 
 ...
 * @lastrevision $Date$
 */
public class UpdateEmailAddressApi extends BaseApi {
	...
	public JsonMessage runApi(final String apiName, final Database db, final ServiceCoreReturn serviceCoreReturn,
		...
		final EmailAddressTable emailAddressTable = ValidateEmail.validateEmailAddressParameters(db, personId, 
		...
		setRecordKey(emailAddressTable.getEmailAddressBean().getEmailAddressKey());
