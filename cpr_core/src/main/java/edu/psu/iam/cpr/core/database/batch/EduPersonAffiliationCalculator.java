...
public class EduPersonAffiliationCalculator extends PersonBio {
	 ...
	 */
	public void setEmployeeAffiliation(final String classCode, final String statusCode, final String specialStatus) throws CprException {
	 ...
	 * @throws CprException will be thrown if there are any CPR related problems.
	 */
	public void setStudentAffiliation(final String statusCode) throws CprException {
		primaryOverride = null;
	 ...
	 * @throws CprException will be thrown if there are any CPR related problems.
	 */
	public void setHMCAffiliation(final long newAffiliation) throws CprException {
	 ...
	 */
	public AffiliationsType calculateEmployeeAffiliation (final String classCode, final String statusCode, final String specialStatus) {
	 ...
	 * @throws CprException will be thrown if there are any CPR related problems.
	 */
	public void updateAffiliations(final AffiliationCalculatorKey key, final long newAffiliationKey) throws CprException {
	 ...
	 */
	private boolean isEmployeeAffiliationKey(final long key) {
	 ...
	 */
	private boolean isStudentAffiliationKey(final long key) {
	 ...
	 */
	private boolean isMemberAffiliationKey(final long key) {
	 ...
	 */
	public PersonAffiliation createPersonAffiliation(final long newAffiliationKey, final String primary) {
	 ...
	 */
	void expirePersonAffiliation(final PersonAffiliation affiliation) {
	 ...
	 */
	private void updatePrimary(final PersonAffiliation bean, final String primaryFlag) {
