...
public class IdCardPrintLogTable {
	 ...
	 */
	public IdCardPrintLogTable( final String eventIdCardNumber) {
	 ...
	 * 
	 */
	public IdCardPrintLogTable( final String eventIdCardNumber, final String eventUserId, final String eventIpAddr , final String eventWorkStation ) {
		super();
