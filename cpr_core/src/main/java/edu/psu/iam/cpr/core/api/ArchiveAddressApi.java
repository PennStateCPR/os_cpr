...
/**
 * This class provides the implementation for the Archive Address API.
 * 
 ...
 * @lastrevision $Date$
 */
public class ArchiveAddressApi extends BaseApi {
	...
	public JsonMessage runApi(final String apiName, final Database db, final ServiceCoreReturn serviceCoreReturn,
		...
		final AddressesTable addressTableRecord = ValidateAddress.validateArchiveAndSetPrimaryAddressParameters(db, personId, addressType, 
												documentType, groupId, updatedBy, addressKey);
