...
public class GeneratedIdentityTable {
	 ...
	 */
	public GeneratedIdentityTable(final long personId, final String generatedIdentity, final String requestedBy) {
	 ...
	 */
	public GeneratedIdentityTable(final long personId, final String generatedIdentity, final String charPart, 
			final Long numPart, final String requestedBy) {
		super();
	 ...
	 */
	public void addGeneratedIdentity(final Session session) {
	 ...
	 */
	public void removeGeneratedIdentity(final Session session) {
