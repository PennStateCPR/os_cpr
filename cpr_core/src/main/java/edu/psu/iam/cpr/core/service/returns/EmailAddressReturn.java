...
public class EmailAddressReturn {
	...
	/** Contains the URI to the resource, only used for RESTful. */
	private String uri;
	
	/**
	 * Constructor with parameters.
	 * @param emailKey contains the email key.
	 ...
	 */
	public EmailAddressReturn(String emailKey, String emailAddressType,
