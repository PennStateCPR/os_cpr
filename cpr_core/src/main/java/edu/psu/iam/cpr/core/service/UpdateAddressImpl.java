...
import edu.psu.iam.cpr.core.api.UpdateAddressApi;
...
public class UpdateAddressImpl extends BaseServiceImpl {
	...
	public void runService(String serviceName, Database db,
		...
		updateAddressApi.implementApi(serviceName, db, updatedBy, serviceCoreReturn, 
				otherParameters, ApiHelper.DO_AUTHZ_CHECK);
		setRecordKey(updateAddressApi.getRecordKey());
	}
}
