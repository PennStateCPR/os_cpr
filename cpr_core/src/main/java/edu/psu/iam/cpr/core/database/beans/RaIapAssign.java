/* SVN FILE: $Id: RaIapAssign.java 5340 2012-09-27 14:48:52Z jvuccolo $ */
...
public class RaIapAssign implements Serializable {
        ...
        @GeneratedValue(strategy=GenerationType.AUTO, generator="seq_ra_iap_assign")
        @SequenceGenerator(name="seq_ra_iap_assign", sequenceName="seq_ra_iap_assign", allocationSize = 1, initialValue= 1)
