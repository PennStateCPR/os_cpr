...
public class UpdateUserCommentImpl extends BaseServiceImpl {
	...
	public void runService(String serviceName, Database db,
		...
		UpdateUserCommentApi updateUserCommentApi = new UpdateUserCommentApi();
		updateUserCommentApi.implementApi(serviceName, db, updatedBy, serviceCoreReturn, 
				otherParameters, ApiHelper.DO_AUTHZ_CHECK);
		setRecordKey(updateUserCommentApi.getRecordKey());
	}
}
