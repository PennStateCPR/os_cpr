...
public class PersonPhotoTable {
	 ...
	 */
	public PersonPhotoTable(final long personId, final byte[] photo, final Date datePhotoTaken, final String updatedBy) {
	 ...
	 */
	public final void setPersonPhotoBean(final PersonPhoto personPhotoBean) {
	 ...
	 */
	public void addPhoto(final Database db) {
	...
	public PhotoReturn[] getPhoto(final Database db, final long personId) {
		...
		for (final Iterator<?> it = query.list().iterator(); it.hasNext(); ) {
			...
			photoReturn.setDateTaken(Utility.formatDateToISO8601(personPhoto.getDateTaken()));
			photoReturn.setLastUpdateBy(personPhoto.getLastUpdateBy());
			photoReturn.setLastUpdateOn(Utility.formatDateToISO8601(personPhoto.getLastUpdateOn()));
			photoReturn.setCreatedBy(personPhoto.getCreatedBy());
			photoReturn.setCreatedOn(Utility.formatDateToISO8601(personPhoto.getCreatedOn()));
