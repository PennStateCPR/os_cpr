...
public class MatchResultsTable implements Comparable<MatchResultsTable> {
	 ...
	 */
	public MatchResultsTable(final Long matchSetKey, final Long personId, final Long score) {
		super();
	 ...
	 */
	public void setMatchSetKey(final Long matchSetKey) {
		this.matchSetKey = matchSetKey;
	}
	 ...
	 */
	@Override
	public int compareTo(final MatchResultsTable mrt) {
