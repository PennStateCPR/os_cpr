/* SVN FILE: $Id: WebService.java 5340 2012-09-27 14:48:52Z jvuccolo $ */
...
public class WebService implements Serializable {
        ...
        @GeneratedValue(strategy=GenerationType.AUTO, generator="seq_web_service")
        @SequenceGenerator(name="seq_web_service", sequenceName="seq_web_service", allocationSize = 1, initialValue= 1)
        ...
        /** Contains the webServiceDesc. */
        @Column(name="web_service_desc", nullable=false, length=150)
