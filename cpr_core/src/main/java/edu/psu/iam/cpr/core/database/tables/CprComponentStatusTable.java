...
public class CprComponentStatusTable {
	 ...
	 */
	public boolean isCprComponentActive(final Database db, final CprComponent cprComponent) {
	 ...
	 */
	public void changeComponentStatus(final Database db, final CprComponent cprComponent, final ComponentStatus componentStatus) {
