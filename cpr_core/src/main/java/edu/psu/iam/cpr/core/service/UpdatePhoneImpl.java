...
import edu.psu.iam.cpr.core.api.UpdatePhoneApi;
 ...
 */
public class UpdatePhoneImpl extends BaseServiceImpl {
	...
	public void runService(String serviceName, Database db,
		...
		UpdatePhoneApi updatePhoneApi = new UpdatePhoneApi();
		updatePhoneApi.implementApi(serviceName, db, updatedBy, serviceCoreReturn, 
				otherParameters, ApiHelper.DO_AUTHZ_CHECK);
		setRecordKey(updatePhoneApi.getRecordKey());
	}
}
