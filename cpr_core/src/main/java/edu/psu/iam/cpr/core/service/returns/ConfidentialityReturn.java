/* SVN FILE: $Id: ConfidentialityReturn.java 5340 2012-09-27 14:48:52Z jvuccolo $ */
package edu.psu.iam.cpr.core.service.returns;

/**
 * This class is used to represent the return from executing a GetConfidentialityHold service call.
 ...
 */
public class ConfidentialityReturn {
	
	/** Contains the type of confidentiality hold. */
	 ...
	 * Constructor.
	 */
	public ConfidentialityReturn() {
		super();
	}
	
	/**
	 * Constructor.
	 * @param confidentialityType contains the confidentiality type.
	 ...
	 */
	public ConfidentialityReturn(String confidentialityType,
	...
	/**
	 * @param confidentialityType the confidentialityType to set
	 */
