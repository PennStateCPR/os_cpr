...
/* SVN FILE: $Id: TransformStatusType.java 5340 2012-09-27 14:48:52Z jvuccolo $ */
...
/**
 * This class defines the ENUMs for the Transform Deliverablity Status.
 * 
...
public enum TransformStatusType {
	...
	TransformStatusType(long index) {
		this.index = index;
	}
	/**
	 * 
