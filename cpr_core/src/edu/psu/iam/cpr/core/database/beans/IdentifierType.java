/* SVN FILE: $Id: IdentifierType.java 5340 2012-09-27 14:48:52Z jvuccolo $ */
...
public class IdentifierType implements Serializable {
        ...
        @GeneratedValue(strategy=GenerationType.AUTO, generator="seq_identifier_types")
        @SequenceGenerator(name="seq_identifier_types", sequenceName="seq_identifier_types", allocationSize = 1, initialValue= 1)
