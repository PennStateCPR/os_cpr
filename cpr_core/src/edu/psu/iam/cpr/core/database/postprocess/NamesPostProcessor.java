...
public class NamesPostProcessor {
	 ...
	 */
	public NamesPostProcessor(StatelessSession statelessSession, MessagingCore messagingCore) {
		super();
	 ...
	 */
	public NamesPostProcessor(Session session, MessagingCore messagingCore) {
		super();
	 ...
	 */
	public void processNameChange(long personId) {
	 ...
	 */
	public void applyNameRules(long personId) {
	 ...
	 */
	public void setLegalName(long personId, NamesStaging namesStagingBean) {
	 ...
	 */
	public void addName(StatelessSession db, NamesStaging namesStagingBean) {
	 ...
	 */
	public void expireName(StatelessSession db, Names bean, String updatedBy) {
		final Date d = new Date();
	 ...
	 */
	public void getAllStagedNamesForPerson(long personId) {
	 ...
	 */
	public void getStudentAidFlag(long personId) {
