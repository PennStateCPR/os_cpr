...
public class ValidateHelper {
	 ...
	 */
	public static String trimField(String input) {
		if (input != null) {
			return input.trim();
		}
		else {
	 ...
	 * @return will return true if the field is empty or false if its not.
	 */
	public static boolean isPhotoEmpty(byte[] input) {
		if (input == null || input.length == 0) {
			return true;
		}
		else {
	 ...
	 */
	public static boolean isFieldLengthValid(Database db, String input, String fieldName) throws CprException {
	 ...
	 */
	public static boolean checkReturnHistory(String input) throws CprException {
	 ...
	 */
	public static String checkField(Database db, String input, String fieldName, String prettyName, boolean checkFieldLength) 
		throws CprException {
