/* SVN FILE: $Id: RaAffiliation.java 5340 2012-09-27 14:48:52Z jvuccolo $ */
...
@Entity
@Table(name="ra_affiliation")
public class RaAffiliation implements Serializable {
        ...
        /** Contains the raAffiliationKey. */
        @Id
        @Column(name="ra_affiliation_key", nullable=false)
        @GeneratedValue(strategy=GenerationType.AUTO, generator="seq_ra_affiliation")
        @SequenceGenerator(name="seq_ra_affiliation", sequenceName="seq_ra_affiliation", allocationSize = 1, initialValue= 1)
        private Long raAffiliationKey;
        ...
        /**
         * @return the raAffiliationKey
         */
        public Long getRaAffiliationKey() {
                return raAffiliationKey;
        }

        /**
         * @param raAffiliationKey the raAffiliationKey to set.
         */
        public void setRaAffiliationKey(Long raAffiliationKey) {
                this.raAffiliationKey = raAffiliationKey;
        }
