/* SVN FILE: $Id: CampusCs.java 5340 2012-09-27 14:48:52Z jvuccolo $ */
...
public class CampusCs implements Serializable {
        ...
        @GeneratedValue(strategy=GenerationType.AUTO, generator="seq_campus_cs")
        @SequenceGenerator(name="seq_campus_cs", sequenceName="seq_campus_cs", allocationSize = 1, initialValue= 1)
