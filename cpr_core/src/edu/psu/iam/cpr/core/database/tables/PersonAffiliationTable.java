...
public class PersonAffiliationTable {
	...
	public AffiliationReturn[] getAllAffiliationsForPersonId(Database db, long personId)  {
	 ...
	 * @return list of PSU Affiliations.
	 */
	public AffiliationReturn[] getInternalAffiliationsForPersonId(Database db, long personId) {
