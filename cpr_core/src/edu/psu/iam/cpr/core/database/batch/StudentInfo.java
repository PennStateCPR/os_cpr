...
public class StudentInfo extends PersonBio {
	 ...
	 */
    public StudentInfo(StatelessSession databaseSession,
     ...
     */
    public void updateStudent(String semesterCode, String campusCode, String registrationStatus, String academicLevel,
             String yearTerm, String graduatingFlag, String semLoaStart, String semLoaEnd, String dormLocation,
             String classLoad, String studentAidFlag) throws CprException {
     ...
     * @throws CprException will be thrown if there are any CPR related problems.
     */
    public void addStudent(String semesterCode, String campusCode, String registrationStatus, String academicLevel,
             String yearTerm, String graduatingFlag, String semLoaStart, String semLoaEnd, String dormLocation,
             String classLoad, String studentAidFlag) throws CprException { 
     ...
     * @throws CprException will be thrown if there are any cpr related problems.
     */
    public void updateStudentAcademicCollege(String semesterCode, String academicCollege, Long rank) throws CprException {
     ...
     * @throws CprException will be thrown if there are any CPR related problems.
     */
     public void addStudentAcademicCollege(String semesterCode, String academicCollege, Long rank) throws CprException {
		// do not attempt to update without mandatory fields.
		if (ValidateHelper.isFieldEmpty(semesterCode) || ValidateHelper.isFieldEmpty(academicCollege)) {
			return;
		}
     ...
     * @throws CprException will be thrown if there are any CPR related problems.
     */
    public void updateStudentMajor(String semesterCode, String major, Long rank) throws CprException {
     ...
     * @throws CprException will be thrown if there are any CPR related problems.
     */
     public void addStudentMajor(String semesterCode, String major, Long rank) throws CprException {
     ...
     * @throws CprException will be thrown if there are any CPR related problems.
     */
    public void updateStudentAcademicDepartment(String semesterCode, String academicDepartment, Long rank) throws CprException {
     ...
     * @param rank contains the rank.
     */
	public void addStudentAcademicDepartment(String semesterCode, String academicDepartment, Long rank) {
