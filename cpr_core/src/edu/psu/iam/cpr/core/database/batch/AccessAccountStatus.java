...
public class AccessAccountStatus {
	 ...
	 */
	public AccessAccountStatus(StatelessSession databaseSession, MessagingCore messagingCore) {
		super();
	 ...
	 */
	public void processStatusChange(long personId, String userid, AccessAccountStatusType accessAccountStatusType) {
	 ...
	 */
	public void processLockedAccountStatus(long personId, String userid) {
	 ...
	 */
	public void processFullAccountStatus(long personId, String userid) {
	 ...
	 */
	public void processPartialAccountStatus(long personId, String userid) {
	 ...
	 */
	public void removeService(long personId, String userid, AccessAccountServiceType accessAccountServiceType) {
	 ...
	 */
	public boolean isServiceActive(long personId, String userid, AccessAccountServiceType accessAccountServiceType) {
	 ...
	 */
	public boolean isAccountNew(long personId, String userid) {
		final StatelessSession session = getDatabaseSession();
	 ...
	 */
	public void addService(long personId, String userid, AccessAccountServiceType accessAccountServiceType) {
