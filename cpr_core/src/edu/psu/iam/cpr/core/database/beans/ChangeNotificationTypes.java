...
public class ChangeNotificationTypes implements Serializable {
        ...
        @GeneratedValue(strategy=GenerationType.AUTO, generator="seq_change_notification_types")
        @SequenceGenerator(name="seq_change_notification_types", sequenceName="seq_change_notification_types", allocationSize = 1, initialValue= 1)
