...
public class ChangeNotifications implements Serializable {
        ...
        @GeneratedValue(strategy=GenerationType.AUTO, generator="seq_change_notifications")
        @SequenceGenerator(name="seq_change_notifications", sequenceName="seq_change_notifications", allocationSize = 1, initialValue= 1)
