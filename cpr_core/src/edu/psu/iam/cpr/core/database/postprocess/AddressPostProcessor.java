...
public class AddressPostProcessor {
	 ...
	 */
	public AddressPostProcessor(StatelessSession statelessSession, MessagingCore messagingCore) {
		super();
	 ...
	 */
	public AddressPostProcessor(Session session, MessagingCore messagingCore) {
		super();
	 ...
	 */
	public void processAddressChange(long personId, AddressType addressType) {
	 ...
	 */
	public void applyAddressRules(long personId, AddressType addressType, AddressStaging bean) {
	 ...
	 */
	public void setChangedAddress(long personId, AddressType addressType, AddressStaging addressStagingBean) {
	 ...
	 */
	public void addAddress(StatelessSession db, AddressType addressType, AddressStaging addressStagingBean) {
	 ...
	 */
	public void expireAddress(StatelessSession db, Addresses bean, String updatedBy) {
		final Date d = new Date();
	 ...
	 */
	public void getAndEvaluateAffiliations(long personId) {
