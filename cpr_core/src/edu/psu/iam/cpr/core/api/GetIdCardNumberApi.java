...
/**
 * This class provides the implementation for the Get Id Card Number API.
 * 
 ...
 * @lastrevision $Date$
 */
public class GetIdCardNumberApi extends ExtendedBaseApi {
	...
	public Object runApi(String apiName, Database db, ServiceCoreReturn serviceCoreReturn,
		...
		return (Object) new PersonIdCardNumberServiceReturn(ReturnType.SUCCESS.index(),
