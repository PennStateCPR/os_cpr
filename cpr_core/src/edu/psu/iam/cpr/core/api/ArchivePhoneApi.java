...
/**
 * This class provides the implementation for the Archive Phone API.
 * 
 ...
 * @lastrevision $Date$
 */
public class ArchivePhoneApi extends BaseApi {
	...
	public JsonMessage runApi(String apiName, Database db, ServiceCoreReturn serviceCoreReturn,
		...
		final PhonesTable phonesTableRecord = ValidatePhone.validateArchiveAndSetPrimaryPhonesParameters(db, personId, 
