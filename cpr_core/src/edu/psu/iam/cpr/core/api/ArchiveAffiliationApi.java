...
/**
 * This class provides the implementation for the Archive Affiliation API.
 * 
 ...
 * @lastrevision $Date$
 */
public class ArchiveAffiliationApi extends BaseApi {
	...
	public JsonMessage runApi(String apiName, Database db, ServiceCoreReturn serviceCoreReturn,
		...
		final PersonAffiliationTable aTableRecord = ValidatePersonAffiliation.validateArchiveAffiliationParameters(db,
						personId, affiliation,  updatedBy);
