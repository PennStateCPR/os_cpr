 ...
 * @lastrevision $Date$
 */
public class GetPersonIdentifierApi extends ExtendedBaseApi {
	...
	public Object runApi(final String apiName, final Database db, final ServiceCoreReturn serviceCoreReturn,
		...
		final String registryIdentifierType = (String) otherParameters.get(IDENTIFIER_TYPE_KEY);
		...
		return new PersonIdentifierServiceReturn(ReturnType.SUCCESS.index(), ApiHelper.SUCCESS_MESSAGE, 
