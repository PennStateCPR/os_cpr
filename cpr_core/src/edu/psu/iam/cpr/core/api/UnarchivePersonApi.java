...
/**
 * This class provides the implementation for the Unarchive Person API.
 * 
 ...
 * @lastrevision $Date$
 */
public class UnarchivePersonApi extends BaseApi {
	...
	public JsonMessage runApi(String apiName, Database db, ServiceCoreReturn serviceCoreReturn,
		...
		final PersonTable personTable = ValidatePerson.validatePersonParameters(db, personId, updatedBy);
		
		// Perform the Unarchive of the person.
		personTable.unarchivePerson(db);
