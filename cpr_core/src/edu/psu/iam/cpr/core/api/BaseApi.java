...
public abstract class BaseApi {
	 ...
	 */
	public ServiceReturn implementApi(String apiName, Database db, String updatedBy, 
			ServiceCoreReturn serviceCoreReturn, Object otherParameters[], 
	...
	public abstract JsonMessage runApi(String apiName, Database db, ServiceCoreReturn serviceCoreReturn, 
			String updatedBy, Object[] otherParameters, boolean checkAuthorization) throws CprException, JSONException, ParseException;
