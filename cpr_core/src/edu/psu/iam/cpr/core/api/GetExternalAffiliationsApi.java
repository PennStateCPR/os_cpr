...
/**
 * This class provides the implementation for the Get External Affiliations API.
 * 
 ...
 * @lastrevision $Date$
 */
public class GetExternalAffiliationsApi extends ExtendedBaseApi {
	...
	public Object runApi(final String apiName, final Database db, final ServiceCoreReturn serviceCoreReturn,
		...
		final PersonAffiliationTable aTable = ValidatePersonAffiliation.validateGetAffiliationsForPersonIdParameters(db, 
								personId, updatedBy, "N");
		
		// Perform the query.
		final AffiliationReturn[] affiliationResults = aTable.getExternalAffiliationsForPersonId(db, personId);
