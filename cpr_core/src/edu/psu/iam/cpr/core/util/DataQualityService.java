...
public class DataQualityService {
	 ...
	 */
	public MatchCodeServiceReturn getAddressMatchCode (String streetLine1, String streetLine2, String streetLine3) {
		return null;
	}
	 ...
	 * @return MatchCodeServiceReturn
	 */
	public MatchCodeServiceReturn getNameMatchCode (String firstName, String middleName, String lastName) {
		return null;
	}
	 ...
	 * @return MatchCodeServiceReturn
	 */
	public MatchCodeServiceReturn getCityMatchCode (String cityName) {
		return null;
	}
	 ...
	 */
	public MatchCodeServiceReturn getMatchCode(String dataType, String dataValue) {
		return null;
	}
	 ...
	 */
	public TransformServiceReturn transformAddress(String address1, String address2, String address3,
