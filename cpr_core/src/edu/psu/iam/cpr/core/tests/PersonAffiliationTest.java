...
public class PersonAffiliationTest {

	PersonAffiliation p = new PersonAffiliation();
	Date d = new Date();
	String s = "abcd";
	
	@Test
	public final void testPersonAffiliation() {
	...
	public final void testGetPrimaryFlag() {
		p.setPrimaryFlag(s);
		AssertJUnit.assertEquals(p.getPrimaryFlag(),s);
	}
	...
	public final void testGetAffiliationKey() {
		p.setAffiliationKey(1L);
		AssertJUnit.assertEquals(p.getAffiliationKey(), new Long(1));
	}
	...
	@Test
	public final void testGetPersonAffiliationKey() {
		p.setPersonAffiliationKey(1L);
		AssertJUnit.assertEquals(p.getPersonAffiliationKey(), new Long(1));
	}

	@Test
	public final void testGetExceptionFlag() {
		p.setExceptionFlag(s);
		AssertJUnit.assertEquals(p.getExceptionFlag(),s);
	}

	@Test
	public final void testGetExceptionComments() {
		p.setExceptionComments(s);
		AssertJUnit.assertEquals(p.getExceptionComments(),s);
	}
