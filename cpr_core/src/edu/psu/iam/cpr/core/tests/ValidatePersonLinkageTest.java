...
public class ValidatePersonLinkageTest {
	...
	public final void testValidateGetPersonLinkageParameters1() throws GeneralDatabaseException, CprException {
		ValidatePersonLinkage.validateGetPersonLinkageParameters(db, 100000L, null,"N");
	}
	@Test(expectedExceptions=Exception.class)
	public final void testValidateGetPersonLinkageParameters2() throws GeneralDatabaseException, CprException {
		ValidatePersonLinkage.validateGetPersonLinkageParameters(db, 100000L, "","N");
	}
	@Test(expectedExceptions=Exception.class)
	public final void testValidateGetPersonLinkageParameters3() throws GeneralDatabaseException, CprException {
		openDbConnection();
	...
	@Test
	public final void testValidateGetPersonLinkageParameters4() throws GeneralDatabaseException, CprException {
		openDbConnection();
	...
	@Test(expectedExceptions=Exception.class)
	public final void testValidatePersonLinkageParameters1() throws GeneralDatabaseException, CprException {
		openDbConnection();
	...
	@Test(expectedExceptions=Exception.class)
	public final void testValidatePersonLinkageParameters2() throws GeneralDatabaseException, CprException {
		openDbConnection();
	...
	@Test(expectedExceptions=Exception.class)
	public final void testValidatePersonLinkageParameters3() throws GeneralDatabaseException, CprException {
		openDbConnection();
	...
	@Test
	public final void testValidatePersonLinkageParameters4() throws GeneralDatabaseException, CprException {
		openDbConnection();
