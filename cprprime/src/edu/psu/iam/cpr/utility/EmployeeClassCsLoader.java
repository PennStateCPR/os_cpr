...
import edu.psu.iam.cpr.utility.beans.EmployeeClassCs;

public class EmployeeClassCsLoader implements BeanLoader {
	...
	public void loadTable(Database db, String primeDirectory, String tableName) {
		...
		try {
			...
			while ((line = bufferedReader.readLine()) != null) {
				...
				EmployeeClassCs bean = new EmployeeClassCs();
				...
				for (int i = 0; i < columns.length; ++i) {
					if (columns[i].equals("class_code")) {
						bean.setClassCode(fields[i]);
					}
					else if (columns[i].equals("class_desc")) {
						bean.setClassDesc(fields[i]);
					}
