...
(function ($) {
	...
	/**
	The commit.currentaddress namespace manages the validation
	rules for the current address screen.

	@namespace currentaddress
	**/
	commit.currentaddress = {
		/**
	...
	// Execute validation.
	commit.currentaddress.initialize();
}(jQuery));