...
/**
 * Matches password rules defined by the commit project.
 *
 ...
 * 
 */
jQuery.validator.addMethod("commitPassword", function (password, element) {
	// Define.
	var valid;
	...
	// ASCII control characters or invisible control characters.
