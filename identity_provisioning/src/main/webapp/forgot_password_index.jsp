...
// }
 ...
 // Redirect the next request at the server, shielding the "forgot_password_connect" action from the end-user
 request.getRequestDispatcher("forgot_password_connect").forward(request, response);
%>
