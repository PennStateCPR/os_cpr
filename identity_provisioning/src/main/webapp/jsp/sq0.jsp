...
<head>
<meta charset="utf-8">
<title><s:property value="#application['ui.sitename']"/>: Match found!</title>
...
<!-- BREADCRUMB TRAIL -->
<div id="breadcrumbs" class="breadcrumb-left navbar-fixed-top-content visible-desktop"> &gt; <s:property value="#application['ui.sitename']"/> &gt; <b>Match Found! </b></div><div class="breadcrumb-right navbar-fixed-top-content visible-desktop"><s:property value="#application['ui.application.id']"/></div>
...
<!-- DATACARD -->
<jsp:include page="datacardSQ0.jsp" />
