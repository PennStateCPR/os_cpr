 ...
 *
 */
public class ForgotPasswordConnectionAction extends RAConnectionAction {
	
	private static final long serialVersionUID = 1L;

	@Override
	@Action(value="forgot_password_connect",results={ @Result(name=SUCCESS, location="/forgot_password", type=REDIRECT),
