...
/**
 * Action handler for the forgotten userid screen.
 * @author jvuccolo
 *
 */
public class ForgotUseridAction extends BaseAction {
	...
	@Override
	@Action(value="forgot_userid",results={ @Result(name=SUCCESS,location="/security_questions",type=REDIRECT),
			                                @Result(name="success_security_questions",location="/security_questions",type=REDIRECT),
                                            @Result(name="stay on page",location="/jsp/forgotUserid.jsp"),
