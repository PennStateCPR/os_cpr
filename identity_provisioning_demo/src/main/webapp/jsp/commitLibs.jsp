...
<script type="text/javascript" src="<s:property value='#JS_LIB_DIR'/>/datelist/datelist-min.js"></script>
...
<script type="text/javascript" src="<s:property value='#JS_LIB_DIR'/>/dob/jquery-dob-min.js"></script>
