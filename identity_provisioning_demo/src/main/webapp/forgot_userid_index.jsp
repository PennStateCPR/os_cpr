...
// }
 ...
 // Redirect the next request at the server, shielding the "forgot_userid_connect" action from the end-user
 request.getRequestDispatcher("forgot_userid_connect").forward(request, response);
%>
